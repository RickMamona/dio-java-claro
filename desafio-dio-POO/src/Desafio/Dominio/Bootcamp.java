...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((dataInicical == null) ? 0 : dataInicical.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (descricao == null) {
            ...
            return false;
        if (dataInicical == null) {
            if (other.dataInicical != null)
                return false;
        } else if (!dataInicical.equals(other.dataInicical))
            return false;
        if (dataFinal == null) {
